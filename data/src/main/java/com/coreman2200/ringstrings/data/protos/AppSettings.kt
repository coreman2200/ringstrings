...
// Source: AppSettings in ringstrings.proto
...
public class AppSettings(
    @field:WireField(  
        tag = 1,  
        adapter = "AppSettings${'$'}GeneralSettings#ADAPTER",
        label = WireField.Label.OMIT_IDENTITY  
    )  
    public val general: GeneralSettings? = null,
    @field:WireField(  
        tag = 2,  
        adapter = "AstrologySettings#ADAPTER",
        label = WireField.Label.OMIT_IDENTITY  
    )  
    public val astro: AstrologySettings? = null,
    @field:WireField(  
        tag = 3,  
        adapter = "NumerologySettings#ADAPTER",
        label = WireField.Label.OMIT_IDENTITY  
    )  
...
) : AndroidMessage<AppSettings, Nothing>(ADAPTER, unknownFields) {
    @Deprecated(
    ...
    public override fun toString(): String {
        ...
        return result.joinToString(prefix = "AppSettings{", separator = ", ", postfix = "}")
    }
    ...
    ): AppSettings = AppSettings(general, astro, num, last_update, unknownFields)

    public companion object {
        @JvmField
        public val ADAPTER: ProtoAdapter<AppSettings> = object : ProtoAdapter<AppSettings>(
            FieldEncoding.LENGTH_DELIMITED,
            AppSettings::class,
            "type.googleapis.com/AppSettings",
            PROTO_3,
            null,
            "ringstrings.proto"
        ) {
            public override fun encodedSize(`value`: AppSettings): Int {
                var size = value.unknownFields.size
                if (value.general != null) size += GeneralSettings.ADAPTER.encodedSizeWithTag(
                    1,
                    value.general
                )
                if (value.astro != null) size += AstrologySettings.ADAPTER.encodedSizeWithTag(
                    2,
                    value.astro
                )
                if (value.num != null) size += NumerologySettings.ADAPTER.encodedSizeWithTag(3, value.num)
                if (value.last_update != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(
                    4,
                    value.last_update
                )
                return size
            ...
            public override fun encode(writer: ProtoWriter, `value`: AppSettings) {
            ...
            public override fun encode(writer: ReverseProtoWriter, `value`: AppSettings) {
                writer.writeBytes(value.unknownFields)
                if (value.last_update != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 4, value.last_update)
                if (value.num != null) NumerologySettings.ADAPTER.encodeWithTag(writer, 3, value.num)
                if (value.astro != null) AstrologySettings.ADAPTER.encodeWithTag(writer, 2, value.astro)
            ...
            public override fun decode(reader: ProtoReader): AppSettings {
            ...
            public override fun redact(`value`: AppSettings): AppSettings = value.copy(
        ...
        @JvmField
        public val CREATOR: Parcelable.Creator<AppSettings> = AndroidMessage.newCreator(ADAPTER)
    ...
    public class GeneralSettings(
        ...
        public companion object {
            ...
            public val ADAPTER: ProtoAdapter<GeneralSettings> = object : ProtoAdapter<GeneralSettings>(
                ...
                "type.googleapis.com/AppSettings.GeneralSettings",
                PROTO_3,
                null,
                "ringstrings.proto"
            ) {
                ...
                public override fun encode(writer: ProtoWriter, `value`: GeneralSettings) {
                    writer.writeBytes(value.unknownFields)
                }

                public override fun encode(writer: ReverseProtoWriter, `value`: GeneralSettings) {
                    writer.writeBytes(value.unknownFields)
                }
