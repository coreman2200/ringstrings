...
import com.coreman2200.ringstrings.domain.MockDefaultDataBundles;
...
import com.coreman2200.ringstrings.data.rsprovider.dao.AstralSymbolDAO;
import com.coreman2200.ringstrings.data.rsprovider.dao.ISymbolDAO;
import com.coreman2200.ringstrings.data.rsprovider.dao.NumberSymbolDAO;
import com.coreman2200.ringstrings.data.rsprovider.dao.ProfileSymbolDAO;
...
public class TestRingStringsContentProvider {
    ...
    public void setup() {
        ...
        IProfileDataBundle bundle = new ProfileDataBundleAdapter(MockDefaultDataBundles.testProfileBundleCoryH);
