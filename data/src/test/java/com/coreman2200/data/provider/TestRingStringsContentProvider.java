package com.coreman2200.data.provider;
...
import com.coreman2200.data.repository.db.dao.AstralSymbolDAO;
import com.coreman2200.data.repository.db.dao.ISymbolDAO;
import com.coreman2200.data.repository.db.dao.NumberSymbolDAO;
import com.coreman2200.data.repository.db.dao.ProfileSymbolDAO;
...
public class TestRingStringsContentProvider {
    ...
    private ProfileInteractor mProfileProcessor;
    ...
    private IProfileSymbol produceTestSubject(LocalProfileDataBundle profile) {
        ...
        IProfileDataBundle bundle = new ProfileDataBundle(profile);
        RingStringsAppSettings settings = MockDefaultDataBundles.produceDefaultAppSettingsBundle();
        mProfileProcessor = new ProfileInteractor(settings);
