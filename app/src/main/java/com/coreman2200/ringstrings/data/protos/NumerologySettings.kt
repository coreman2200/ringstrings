...
// Source: com.coreman2200.ringstrings.data.protos.NumerologySettings in ringstrings.proto
...
public class NumerologySettings(
  @field:WireField(
    tag = 1,
    adapter =
        "com.coreman2200.ringstrings.data.protos.NumerologySettings${'$'}NumberSystemType#ADAPTER",
  ...
  public fun copy(number_system: NumberSystemType = this.number_system, unknownFields: ByteString =
      this.unknownFields): NumerologySettings = NumerologySettings(number_system, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<NumerologySettings> = object :
      ...
      "type.googleapis.com/com.coreman2200.ringstrings.data.protos.NumerologySettings", 
      PROTO_3, 
      null, 
      "ringstrings.proto"
    ) {
      ...
      public override fun encode(writer: ProtoWriter, `value`: NumerologySettings): Unit {
      ...
      public override fun encode(writer: ReverseProtoWriter, `value`: NumerologySettings): Unit {
        writer.writeBytes(value.unknownFields)
        if (value.number_system != NumberSystemType.CHALDEAN)
            NumberSystemType.ADAPTER.encodeWithTag(writer, 1, value.number_system)
      }
