...
// Source: com.coreman2200.ringstrings.data.protos.Placement in ringstrings.proto
...
public class Placement(
  @field:WireField(
    tag = 1,
    adapter = "com.coreman2200.ringstrings.data.protos.Placement${'$'}Location#ADAPTER",
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<Placement> = object : ProtoAdapter<Placement>(
      ...
      Placement::class, 
      "type.googleapis.com/com.coreman2200.ringstrings.data.protos.Placement", 
      PROTO_3, 
      null, 
      "ringstrings.proto"
    ) {
      ...
      public override fun encode(writer: ProtoWriter, `value`: Placement): Unit {
      ...
      public override fun encode(writer: ReverseProtoWriter, `value`: Placement): Unit {
        writer.writeBytes(value.unknownFields)
        if (value.timezone != "") ProtoAdapter.STRING.encodeWithTag(writer, 3, value.timezone)
        if (value.timestamp != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 2, value.timestamp)
        if (value.geo != null) Location.ADAPTER.encodeWithTag(writer, 1, value.geo)
  ...
  public class Location(
    ...
    public companion object {
      ...
      public val ADAPTER: ProtoAdapter<Location> = object : ProtoAdapter<Location>(
        FieldEncoding.LENGTH_DELIMITED, 
        Location::class, 
        "type.googleapis.com/com.coreman2200.ringstrings.data.protos.Placement.Location", 
        PROTO_3, 
        null, 
        "ringstrings.proto"
      ) {
        public override fun encodedSize(`value`: Location): Int {
          var size = value.unknownFields.size
          if (value.longitude != 0.0) size += ProtoAdapter.DOUBLE.encodedSizeWithTag(1,
              value.longitude)
          if (value.latitude != 0.0) size += ProtoAdapter.DOUBLE.encodedSizeWithTag(2,
              value.latitude)
          if (value.altitude != 0.0) size += ProtoAdapter.DOUBLE.encodedSizeWithTag(3,
              value.altitude)
          return size
        }
