package com.coreman2200.ringstrings.domain.symbol.entitysymbol.Tags;
...
public class ValueSymbolImpl implements IValueSymbol {
    ...
    public SymbolStrata strata() { return SymbolStrata.SYMBOL; }

    public Enum<? extends Enum<?>> id() { return NumberStrata.BASENUMBER; }
