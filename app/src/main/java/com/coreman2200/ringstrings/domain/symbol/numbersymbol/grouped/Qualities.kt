 ...
 */
enum class Qualities : IGroupedNumberSymbolID {
    LIFEPATH, BALANCE, EXPRESSION, MATURITY, RATIONALTHOUGHT, SOULURGE, SUBCONSCIOUSSELF, PERSONALITY, HIDDENPASSIONS, KARMICLESSON
}