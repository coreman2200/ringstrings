...
class GroupedNumberSymbol(
    ...
    override fun add(group: IGroupedNumberSymbolID, symbol: NumberSymbol) {
        related[group] = symbol
        add(symbol)
    }

    override fun add(map: Map<IGroupedNumberSymbolID, NumberSymbol>) {
        related.putAll(map)
