...
import com.coreman2200.rsgfx.RSGFXEntity;

import android.util.Log;

import com.coreman2200.ringstrings.oldz.astrology.Astrology;
import com.coreman2200.ringstrings.oldz.deprbizlogic.GlobalLL;
import com.coreman2200.ringstrings.oldz.deprbizlogic.RSMath;
import com.coreman2200.ringstrings.oldz.deprbizlogic.RingString;
import com.coreman2200.ringstrings.oldz.io.orientateRunnable;
...
public class HigherEntity extends Entity {
	...
	public void compareEnts() {
		...
		if (MySelf == null)
			MySelf = (Person) ALLPEOPLE.getChild(0);
