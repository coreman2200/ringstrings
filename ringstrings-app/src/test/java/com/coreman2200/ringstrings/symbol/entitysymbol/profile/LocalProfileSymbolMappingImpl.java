...
public class LocalProfileSymbolMappingImpl extends ProfileSymbolMappingImpl {

    public LocalProfileSymbolMappingImpl(IProfileTestLoc profile) {
        super(EntityStrata.PROFILE, profile);
    }
