...
public final class SymbolIDBundle extends Message<SymbolIDBundle, SymbolIDBundle.Builder> {
  public static final ProtoAdapter<SymbolIDBundle> ADAPTER = new ProtoAdapter<SymbolIDBundle>(FieldEncoding.LENGTH_DELIMITED, SymbolIDBundle.class) {
    ...
    public int encodedSize(SymbolIDBundle value) {
      return (value.profile_id != null ? ProtoAdapter.INT32.encodedSizeWithTag(1, value.profile_id) : 0)
          ...
          + (value.settings != null ? RingStringsAppSettings.ADAPTER.encodedSizeWithTag(8, value.settings) : 0)
    ...
    public void encode(ProtoWriter writer, SymbolIDBundle value) throws IOException {
      ...
      if (value.settings != null) RingStringsAppSettings.ADAPTER.encodeWithTag(writer, 8, value.settings);
    ...
    public SymbolIDBundle decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 8: builder.settings(RingStringsAppSettings.ADAPTER.decode(reader)); break;
          default: {
  ...
  public SymbolIDBundle(Integer profile_id, Integer chart_id, Integer strata_id, Integer type_id, Integer symbol_id, Integer desc_id, String name, RingStringsAppSettings settings) {
    this(profile_id, chart_id, strata_id, type_id, symbol_id, desc_id, name, settings, ByteString.EMPTY);
  }

  public SymbolIDBundle(Integer profile_id, Integer chart_id, Integer strata_id, Integer type_id, Integer symbol_id, Integer desc_id, String name, RingStringsAppSettings settings, ByteString unknownFields) {
    super(unknownFields);
  ...
  public static final class Builder extends com.squareup.wire.Message.Builder<SymbolIDBundle, Builder> {
    ...
    public SymbolIDBundle build() {
      return new SymbolIDBundle(profile_id, chart_id, strata_id, type_id, symbol_id, desc_id, name, settings, buildUnknownFields());
    }
  }
}
