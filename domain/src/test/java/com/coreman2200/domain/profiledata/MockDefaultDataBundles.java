...
public final class MockDefaultDataBundles {
    ...
    private static final com.coreman2200.domain.protos.RingStringsAppSettings.NumerologySettings.NumberSystemType DFLT_NUMBERSYSTEM = RingStringsAppSettings.NumerologySettings.NumberSystemType.PYTHAGOREAN;
    ...
    public static final LocalProfileDataBundle generateRandomProfile() {
        LocalProfileDataBundle.Name fullname = generateRandomProfileName();
        LocalProfileDataBundle.Name displayname = generateDisplayNameFromFullName(fullname);
    ...
    private static final LocalProfileDataBundle.Name generateDisplayNameFromFullName(LocalProfileDataBundle.Name name) {
        List<String>  testName = new ArrayList<>();
        testName.add(name.segments.get(0));
        testName.add(name.segments.get(2));
    ...
    public static final RingStringsAppSettings produceDefaultAppSettingsBundle() {
        final String ephe_dir = "ephe/";
