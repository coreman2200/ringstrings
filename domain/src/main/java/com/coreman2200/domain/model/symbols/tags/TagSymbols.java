package com.coreman2200.domain.model.symbols.tags;
...
public enum TagSymbols implements ITagSymbol {
    ...
    @Override
    public Collection<ITagSymbol> getQualities() {
        Collection<ITagSymbol> tags = new ArrayList<>();
        tags.add(this);
        return tags;
    }
    ...
    static public ITagSymbol getTagForString(String name) {
