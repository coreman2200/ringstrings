package com.coreman2200.domain.model.profiles;
...
public class ProfileDataBundle implements IProfileDataBundle {
    ...
    public ProfileDataBundle(LocalProfileDataBundle bundle) {
        mProfileData = bundle;
