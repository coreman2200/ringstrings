...
public class RandomizedTestProfileImpl  implements IProfile {
    ...
    private static int[] testDate = new int[3];
    ...
    public void genProfile() {
        ...
        testDate[0] = (int)(Math.random()*31)+1;
        testDate[1] = (int)(Math.random()*12)+1;
        testDate[2] =  1600 + (int)(Math.random()*800);
        System.out.println("Name: " + getFirstName() + " " + getMiddleName() + " " + getLastName());
        System.out.println("Birth: " + getBirthMonth() + "/" + getBirthDay() + "/" + getBirthYear());
