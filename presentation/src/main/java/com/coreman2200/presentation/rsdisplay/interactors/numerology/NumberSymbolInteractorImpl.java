...
public class NumberSymbolInteractorImpl extends AbstractInteractor implements INumberSymbolInteractor {
    private static final char[] VOWEL_LIST = {'a', 'e', 'i', 'o', 'u', 'y'};
    protected INumberSystem mNumberSystem;
    int[] derivedFromValues = new int[2];

    public NumberSymbolInteractorImpl(RingStringsAppSettings settings) {
        super(settings);
    }
